...
## Pre-requisites
This project expects the following files in the `data/` folder (not included in this repo, can be downloaded from [[1]](#1)):
...
The following 2 additional datasets below should also be in the `data/` folder and can be found in [[2]](#2):
...
<a id="2">[2]</a> NYT datasets: https://github.com/touche-webis-de/touche-code/tree/main/semeval23/human-value-detection/nyt-downloader

<a id="3">[3]</a> Best model: https://drive.google.com/file/d/1wbznu605vpJtr3YErOkl27cynj95XMpX/view?usp=drive_link 
